    ...
    <section className="bg-navy py-20 text-white sm:py-28">
      <Container>
        ...
        <ol className="relative mt-14 space-y-10 sm:hidden">
          <div aria-hidden className="absolute top-1.5 bottom-1.5 left-[3px] w-px bg-white/15" />
        ...
        <ol className="relative mt-20 hidden sm:grid sm:grid-cols-4 sm:gap-10">
          <div aria-hidden className="absolute top-[5px] right-0 left-0 h-px bg-white/15" />
          {legacyTimeline.map((entry) => (
            <li key={entry.year} className="relative pt-8">
